  ...
  <div class="modal-window__film">
    ...
    <div class="modal-window__content">
      ...
      <div class="modal-window__info">
        <ul>
          <li class="modal-window__review--text">Vote / Votes</li>
          <li class="modal-window__review--text">Popularity</li>
          <li class="modal-window__review--text">Original Title</li>
          <li class="modal-window__review--text">Genre</li>
        </ul>
        <ul class="modal-window__info--data">
          ...
          <li class="modal-window__data--popul">${popularity
        .toString()
        .slice(0, -4)}</li>
          <h3 class="modal-window__data--title">${original_title}</h3>
          <li class="modal-window__data--genre">${genres.map(gen => gen.name)}</li>
        </ul>
      </div>    
