...
})({"ajfaR":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "993a93d5ffe12476";
...
},{}],"7l6d3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _apiKeys = require("./api-keys");
var _renderTrends = require("./render-trends");
...
async function fetchTrendMovies() {
    try {
        const { data  } = await (0, _axiosDefault.default).get(`${(0, _apiKeys.BY_TRENDS)}?api_key=${(0, _apiKeys.KEY)}&page=${page}`);
        return data;
    } catch (error) {
        console.error("ERROR");
    }
...
//Fetch by Search
async function fetchBySearchMovies(formInput, page1) {
    try {
        const { data  } = await (0, _axiosDefault.default).get(`${(0, _apiKeys.BY_SEARCH)}?api_key=${(0, _apiKeys.KEY)}&query=${formInput}&page=${page1}`);
        return data;
    } catch (error) {
        console.error("ERROR");
    }
...
fetchTrendMovies().then((data)=>{
    (0, _renderTrends.renderCollection)(data);
    console.log(data.results);
});
// Проверка пагинации 
function more() {
...
},{"axios":"jo6P5","./api-keys":"93ite","./render-trends":"4rSF9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
...
},{"./../utils":"5By4s"}],"93ite":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "KEY", ()=>KEY);
parcelHelpers.export(exports, "DEFAULT_URL", ()=>DEFAULT_URL);
parcelHelpers.export(exports, "BY_TRENDS", ()=>BY_TRENDS);
parcelHelpers.export(exports, "BY_SEARCH", ()=>BY_SEARCH);
parcelHelpers.export(exports, "BY_ID", ()=>BY_ID);
parcelHelpers.export(exports, "renderPoster", ()=>renderPoster);
...
},{}],"4rSF9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function renderCollection(movie1) {
    const markup = movie1.results.map((movie)=>{
        const { id , title , poster_path , genre_ids , overview , vote_average , release_date ,  } = movie;
        return `
       <img src="${0, _apiKeys.renderPoster}${poster_path} " />
      <p>ID: ${id}</p>
       <p>${title}</p>
       <p>${overview}</p>
...
},{"./api-keys":"93ite","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ajfaR","7l6d3"], "7l6d3", "parcelRequired7c6")

//# sourceMappingURL=index.ffe12476.js.map
